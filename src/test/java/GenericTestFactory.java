...
public final class GenericTestFactory {
    ...
    public static <T> boolean testConstructorExists(Class<T> clazz, Object[] parameters ){
        if(parameters == null)
        ...
        try {
            Constructor constructor = clazz.getConstructor(parametersTypes);
            return true;
    ...
    public static boolean testConstructorExists(Class clazz, Object[] parameters,boolean isPrimitiveTypes ){
        if(parameters == null)
            parameters = new Object[0];
        ...
        for (int i = 0; i < parameters.length; i++){
            if(isPrimitiveTypes)
                parametersTypes[i] = convertToPrimitiveType(parameters[i].getClass());
            else
                parametersTypes[i] = parameters[i].getClass();
